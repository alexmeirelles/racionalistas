...
5. Commit:
   ```bash
   node "/Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
