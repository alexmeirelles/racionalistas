...
- **Global scope**: `/Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/notes/`)
...
2. Glob `/Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/notes/` — works in any directory
