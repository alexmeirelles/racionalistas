...
- Usage: Reference from command with `@/Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/alexandremeirelles/Projetos/Racionalistas/racionalistas-hub/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
