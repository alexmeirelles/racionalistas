...
export const wikiContent: WikiModel[] = [
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>O grande mal de diversas assessorias no topo focadas digitalmente: se você pagar por marketing de agências eles empurrarão agressivamente a contratação imediata da sua produção no tráfego social apontando faltas massivas nos criativos pois é a ferramenta bruta unívoca reinante perante qualquer chapa; mesmo que no buraco do balanço a resposta genial fosse cortar imediatamente as dívidas internas se...</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Sistemas de Enterprise Resources (como os gigantes softwares SAP utilizados para gestão alemã corporativa). Mudar uma base imensa e integrada desse escopo gera imenso medo, pausa incontrolável da produtividade, retreinos excruciantes pelo ecossistema financeiro das marcas globais. As multinacionais apenas assinam os boletos cada vez maiores e reajustes na anuidade sob o silêncio de saber que reade...</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>A crise financeira no abismo generalizado do cenário imobiliário global no apagar do ano base destruiu fundos centenários protegidos porque nenhum sistema projetado nos lucros medievais supôs um alinhamento em todos colapsos unificados numa cascata imprevisível arrasadora num evento altamente letal sem registros passados esvaziando trilhões ignorando distribuições passadas limitadas sob cálculos p...</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>As IAs primordiais nas pontes do aprendizado automático sob as redes neurais pesadas de feedback no caso da grande OpenAI, onde bilhões de dados saídas do tráfego humano refazem todo passo retreinando e aprimorando atalhos corretos baseados nas reprovações nas lacunas na ponta melhorando toda a estrutura anterior repetida num avanço explosivo cíclico rumo as perfeições na resposta contínua na evol...</p>",
