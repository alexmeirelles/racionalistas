...
export const wikiContent: WikiModel[] = [
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Na fundação da FedEx, pacotes noturnos atrasavam constantemente porque os operários eram pagos por hora (incentivando lentidão). Quando Fred Smith mudou a regra e passou a pagar um valor fixo pelo turno, permitindo que fossem para casa assim que os aviões estivessem carregados, os atrasos zeraram quase da noite para o dia.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>O crescimento inicial do PayPal decolou incrivelmente quando os fundadores criaram robôs (bots) que simulavam demanda real para comprar itens no eBay usando o PayPal. Vendo múltiplos 'compradores' exigindo a plataforma, os vendedores reais aderiram em massa para não perder vendas, ativando uma gigantesca manada humana.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>A HubSpot praticamente inventou o 'Inbound Marketing' entregando ferramentas gratuitas (como o Website Grader) e conteúdos de altíssimo valor de graça. Quando a empresa finalmente oferecia o software pago, o senso de retribuição e confiança nos leads era tão grande que a fricção de venda derreteu.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Quando o Nubank lançou o cartão roxinho, em vez de focar no que você ganhava, a narrativa inicial massificava o que você estava perdendo: horas dasua vida em filas e montanhas de dinheiro do seu bolso em taxas bancárias invisíveis. O medo de continuar perdendo foi brutalmente persuasivo.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>As campanhas clássicas da Apple com 'Think Different' não falavam primeiramente sobre processadores ou tela, mas ancoravam a marca na autoridade de gênios indiscutíveis (Einstein, Picasso). Essa transferência indireta de autoridade e credibilidade fez a marca transcender os limites de simples computadores de mesa.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>A Netflix construiu seu algoritmo de recomendação com o propósito claro de capitalizar no viés de confirmação visual. Eles renderizam artes e capas para os mesmos exatos filmes de formas diferentes dependendo do seu último histórico (trazendo astros pontuais baseados naquilo que seu cérebro já ama clicar), validando antecipadamente sua escolha cega.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Um dos enormes motores orgânicos de aplicativos fitness como o Strava. O ser humano não se move unicamente com tabelas pessoais base de treinos, mas ao expor abertamente num mural o recorde impensável feito no último pedal na estrada pelo colega na manhã de domingo, a inveja do status e de superioridade incita todos de novo as esteiras na próxima alvorada com fogo inexplorado.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>No revolucionário modelo da assinatura do serviço do Amazon Prime as pessoas aderem massivamente com apenas frete e comodidade mental de não pensar mais; depois do pedágio da taxa ser pago, suas mentes lutam intensamente para comprar cada clipe novo de plástico direto da logomarca da Amazon apenas forçando internamente do gasto fixo compensar, abraçando cegamente toda nova encomenda cega no mesmo carrinho.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Charlie Munger quando abordado sem hesitação focava apenas nisso: 'Eu não recruto e desejo a receita perfeita para faturar genialmente as minhas maiores somas como apostador financeiro, eu simplesmente coleciono uma lista sagrada focada nas decisões extremas tomadas que causaram a miséria dos homens normais para poder evadir e escapar abertamente pelo avesso'.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Na criação sob império dos ingleses na base asiática sofreram com a super-infestação nas mortais cobras nativas. Implementaram e pagaram altas quantias como incentivo simples por cada criatura peçonhenta caída abatida; Na segunda esteira impensável as milícias coloniais pararam todos os trabalhos agrários apenas pra botarem filhotes vivos pra chocarem fazendas das criaturas envenenadas na intenção bruta de extrair riquezas eternas do exército (Efeito Cobra).</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Na genialidade do oráculo focado no longo alcance Buffett foca exclusivamente apostas contidas para companhias centenárias sem surpresas destrutivas, enquanto vira de imediato o rosto para apostas exóticas abertas mesmo faturando imensos lucros da noite pro amanhecer simplesmente negando porque os fundos dele acorrentados ali sangrariam na impossibilidade temporal parados cegos de caírem abertos dentro de negócios simples absolutos gigantes com seu ganho monumental.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Enquanto diversas pequenas estruturas inovadores da web abusam e queimam suas reservas numa eficiência desgrenhada rumo aos picos dos unicórnios esvaziando fôlegos para lucrar antes de abismos no mercado; Companhias na fortificada fortaleza gigantesca como a Microsoft não investem em apostas finais cruéis estocando absurdos de lucros intocados como base fria imune imperturbável resistindo a secas econômicas para sempre terem ar onde tentar sem matar o balanço de despesas.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Estrategistas da velha guarda recusam frotas de oportunidades quentes e infalíveis prometidas da noite na fronteira cripto desconhecida do Vale pelo puro medo frio; Não pela falta crônica de inteligência extrema necessária nas métricas mas da completa inaptidão e confissão explícita do ambiente selvagem da moda fugir das amarras absolutas na precisão mental enjauladas onde eles habitavam anos dominando sem esforço (saindo limpos do desastre final das pontocom).</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Nas antigas estruturas perversas industriais asiáticas (Sistema Toyota) transformaram tudo removendo fardos em culpa dos chefes operários preguiçosos ou falhos baseando tudo apenas nas deficiências rústicas amadoras deixadas pelo projeto; a base da incompetência imposta na fiação do processo falho tira totalmente a energia das acusações da má-intenção pura humana paranoica focando cega em reformar de perto as correções de peças abertas quebradas soltas sem medo.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Durante uma campanha monumental no frio as planilhas das vitórias e relatórios das engrenagens apontam rendimentos garantidos nos escritórios corporativos mas apenas líderes como Steve Jobs perseguiam as ruas nos mercados descobrindo a realidade fria impiedosa tátil provando as limitações físicas na quebra sem aviso num ambiente puramente incontrolável que renega todas ilusões em maquetes de laboratório imaculada provando o mercado impiedoso real abafando teorias.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Redesenhando a base dos insanos custos de foguete os técnicos da SpaceX paralisaram de escutar da força aérea das regras na tradição limitante em aceitar orçamentos finais pesados imutáveis; Eles simplesmente decomporam os minérios cruos (carbono frio bruto e alumínio isolado na esteira fina bruta industrial na mesa) refazendo puramente os montantes nas matrizes exatas iniciais zeradas despencando lucros de intermediários matando todos antigos tabus numa fração absurda.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>O poço mais mortal contra imitadores esconde-se muito nas águas gigantes da Disney; não são meros parquinhos de lanchonete criativos de aço mas uma redoma gigantesca intransponível invisível emocional presa fundo da nostalgia inter-gerações onde pais abrigam carinhos absolutos e cegos da juventude amarrados com ferros empurrando incondicionalmente a base sentimental na alma das novas crianças garantindo lucros puros num balanço emocional infinito trancafiado impenetrável as réplicas rivais.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Super cadeias puras massificadas e de peso infinito destruidoras dos mercados locais formigam sobre os rios de compras e lotes comprando por toneladas insondáveis diretamente do criador para si mesmo; matam cruelmente sem suor a mercearia de canto pois absorvem todos os choques passivos no frete pagando moedas nas produções pela vastidão esmagadora descarregando isso como bônus sangrento invencível nos prateleiras cortando de fato preços inacreditáveis impossíveis pro micro comércios.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>O LinkedIn é funcionalmente inútil sem bilhões de contatos no fundo falso, não importa a tecnologia primorosa instalada na superfície. O ganho da máquina ocorre unicamente pela volumetria das conexões entre as pontas unindo empresas e programadores atraindo cada vez mais novos pares. Plataformas clone de recrutamento não os assustam pois falta-lhes as raízes profundas na malha principal.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Sistemas de Enterprise Resources como os gigantes ERPs SAP utilizados para gestão corporativa geram um lock-in brutal. Mudar uma base imensa e integrada desse escopo gera imenso medo, pausa incontrolável da produtividade e retreinos excruciantes pelo ecossistema financeiro das marcas globais. As multinacionais apenas assinam os boletos cada vez maiores e reajustes na anuidade sob o silêncio de saber que readequar a plataforma cobraria um custo excruciante superior aos boletos.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>A transição brutal interna que a Netflix abraçou na era próspera sob os DVDs. Com rendimentos fantásticos na malha de correios de mídias por correspondência eles optaram impulsionar abertamente as vias pesadas via streaming nas nuvens esvaziando o império da mídia postal deles antes da tecnologia do mercado vir assassinar abertamente os lucros de filmes por aluguel.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Contratos pesados nos convênios do plano de saúde tradicional sofrem abertamente o dano e a sangria dessa espiral. Jovens audaciosos na academia são resistentes com saúde em dia, pagam os prêmios na ausência do serviço mantendo o caixa. Entretanto as agências tendem a ser esmagadas com custos assombrosos repassados nas perdas pois a grande atração e retenção orgânica vai pro público gravemente doente do asilo na necessidade diária, sangrando a proteção inicial.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Lançamentos e drops em marcas (como coleções limitadíssimas ou esvaziados sapatos com traços específicos via hype) injetam intencionalmente em suas fábricas e estoques apenas escassas unidades, enquanto provocam o furor com audiência bilionária e engajada inflando o desejo primário da oferta ao impossível mantendo assim abertamente precificados os produtos a níveis ridículos fora de bases puramente matemáticas de manufatura (caso Rolex).</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Fundo gigantes do Vale do Silício como a Y-Combinator tratam de assimetrias pesadas e EV ao injetar capital nas incipientes ideias precoces das startups pelo mundo. Sabem abertamente nos escritórios que 90% das mil e tantas empresas vão queimar o capital fechando a porta, mas uma que explode e transforma num gigante Airbnb e resgata absurdamente pagando todas perdas passadas da vida e rendendo em lucro absoluto nos portfólios no valor estimado.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Técnicos renomados aterrissam num gigante clube com piores pontuações já avistadas. Logo de imediato a base ruim de azar se finda retornando na tabela do reajuste. De maneira inversa grandes analistas preveem rendimentos de ouro nas maiores atuações do negócio nas cotações altas após pico sem esperar que a sorte rege o negócio caindo do nada na realidade monótona da linha original mediana abafando atuações brilhantes passadas.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Os cassinos funcionam abertamente nas cidades ao tratar dos números. Ao permitirem prêmios altos em uma e outra noite as estatísticas se acalmam garantindo as leis matemáticas para eles nas milhões de mãos na baralha ou nas roletas garantindo uma margem na mínima fração para eles onde pagam as montanhas sem medo do acaso falhar, na constância do evento repetido de probabilidades cegas infinitas.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>A invenção do Whatsapp, e demais ferramentas na ponta social. Somente quando a rede dominou a massa crítica de todos os seus contatos que a usavam, o aplicativo de mensagem abandonou o anonimato virando as chaves pro efeito viral massificando organicamente toda face universal de usuários para envio primário quebrando resistência da adoção.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>Saturação perversa das margens da Meta ads e anúncios em campanhas bilionárias; Onde a tática genial de empurrar orçamentos brutos que faturavam altíssimo num investimento leve de campanha se desconfiguram perante o mundo estragando na exaustão que causa tédio nos consumidores. Adicionar o dobro de dinheiro não dobra os resultados, e às vezes, quebra a conversão completamente por complexidade.</p>",
  ...
  },
  {
    ...
    "detailedContent": [
      ...
      "<strong style=\"color: var(--off-white); display: block; margin-top: 16px; margin-bottom: 8px;\">Caso de Estudo Comprovado</strong><p>As IAs primordiais nas pontes do aprendizado automático sob as redes neurais pesadas de feedback no caso da grande OpenAI. Bilhões de parâmetros sendo testados onde cada erro retroalimenta o modelo forçando-o a não errar da próxima vez. O resultado cíclico gera a explosão autônoma das inteligências que presenciamos.</p>",
